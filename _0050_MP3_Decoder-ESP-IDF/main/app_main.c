...
char *urls[PLAYLIST_LEN]= {PLAYLIST_URL_0, PLAYLIST_URL_1, PLAYLIST_URL_2, PLAYLIST_URL_3, PLAYLIST_URL_4, PLAYLIST_URL_5};

static void start_web_radio()
{
    // init web radio
    web_radio_t *radio_config = calloc(1, sizeof(web_radio_t));
    radio_config->urls = urls; 
	radio_config->url_listindex = 0;
	radio_config->url_listlen = PLAYLIST_LEN;
    radio_config->url = urls[0];
	//ESP_LOGI(TAG, "URL: %s", radio_config->url);
	...
	//renderer_config->sample_rate_modifier = 1;
#endif
